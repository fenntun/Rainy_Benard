...
problem = de.ParsedProblem(axis_names=['x','z'],
                           field_names=['p','b','u','w','bz','uz','wz','temp','q','qz'],
...
x_basis = de.Fourier(768, interval=(0, Lx), dealias=2/3)
z_basis = de.Chebyshev(129, interval=(0, Lz), dealias=2/3)
domain = de.Domain([x_basis, z_basis], grid_dtype=np.float64)

# Finalize problem
problem.parameters['Eu'] = 1.0
problem.parameters['Prandtl'] = 1.0
problem.parameters['Ra'] = 2000000.0
